    TODO:
    - Left Sidebar:
      - Sidebar menu collapse keyboard control (Use unstyled button)
      - Sidebar region marker (see submission_list.vue for example)
      - Sidebar group list keyboard navigability
      - Filter menu keyboard navigability
      - Darken colors for ungraded and in progress group names text (group

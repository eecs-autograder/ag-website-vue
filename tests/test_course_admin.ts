...
import { Course, Project, Semester,
         UltimateSubmissionPolicy, User } from 'ag-client-typescript';
import Vue from 'vue';
...
describe('Course_Admin tests', () => {
    ...
    test.only("Clicking on the Settings tab shows the settings inputs", async () => {
    ...
    test("Clicking on the Permissions tab shows the admins roster by default", async () => {
        // mock all user getters?
    });

    test("Clicking on the Projects tab shows the projects for the course", async () => {
    ...
    test("The course's name, semester, year, and number of late days can be updated", async () => {

    });

    test("A course cannot have less than 0 late days", async () => {

    });

    test("The last saved timestamp gets updated whenever there is a change to the course " +
         "settings",
         async () => {

    });

    test("All admins are displayed in the admins permission tab", async () => {

    });

    test("All staff are displayed in the admins permission tab", async () => {

    });

    test("All students are displayed in the admins permission tab", async () => {

    });

    test("All handgraders are displayed in the admins permission tab", async () => {

    });

    test("Admins can be added to the admins roster", async () => {

    });

    test("Staff can be added to the staff roster", async () => {

    });

    test("Students can be added to the students roster", async () => {

    });

    test("Handgraders can be added to the handgraders roster", async () => {

    });

    test("Admins can be removed from the admins roster", async () => {

    });

    test("Staff can be removed from the staff roster", async () => {

    });

    test("Students can be removed from the students roster", async () => {

    });

    test("Handgraders can be removed from the handgraders roster", async () => {

    });

    test("Individuals cannot have two different roles in a course?", async () => {

    });

    test("Users can create new projects for a course", async () => {

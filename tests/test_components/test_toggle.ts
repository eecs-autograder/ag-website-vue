...
describe('Toggle.vue', () => {
    ...
    test('Toggle data set to default values when not specified by parent', () => {
        ...
        expect(wrapper.vm.state.is_on).toBe(false);
    });
    ...
    test('Toggle data set to values passed in by parent', () => {
        ...
        expect(wrapper.vm.state.is_on).toBe(true);
    ...
    test("v-model binding", async () => {
        ...
        expect(toggle.vm.state.is_on).toEqual(false);

        await set_data(wrapper, {my_toggle: true});
        expect(toggle.vm.state.is_on).toEqual(true);

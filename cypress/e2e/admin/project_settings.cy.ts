...
describe("project settings page as admin", () => {
  ...
  it("has functioning navbar tabs", function () {
    cy.visit(this.page_uri)
      ...
      .click()
      .url()
      .should("eq", build_full_url(`${this.page_uri}?current_tab=settings`));
    ...
    cy.visit(this.page_uri)
      ...
      .should(
        "eq",
        build_full_url(`${this.page_uri}?current_tab=instructor_files`),
      );
    ...
    cy.visit(this.page_uri)
      ...
      .should(
        "eq",
        build_full_url(`${this.page_uri}?current_tab=expected_student_files`),
      );
    ...
    cy.visit(this.page_uri)
      ...
      .click()
      .url()
      .should("eq", build_full_url(`${this.page_uri}?current_tab=test_cases`));
    ...
    cy.visit(this.page_uri)
      ...
      .should(
        "eq",
        build_full_url(`${this.page_uri}?current_tab=mutation_testing`),
      );
    ...
    cy.visit(this.page_uri)
      ...
      .click()
      .url()
      .should("eq", build_full_url(`${this.page_uri}?current_tab=edit_groups`));
    ...
    cy.visit(this.page_uri)
      ...
      .should(
        "eq",
        build_full_url(`${this.page_uri}?current_tab=download_grades`),
      );
    ...
    cy.visit(this.page_uri)
      ...
      .click()
      .url()
      .should("eq", build_full_url(`${this.page_uri}?current_tab=rerun_tests`));
    ...
    cy.visit(this.page_uri)
      ...
      .click()
      .url()
      .should("eq", build_full_url(`${this.page_uri}?current_tab=handgrading`));
    ...
    cy.visit(this.page_uri)
      ...
      .click()
      .url()
      .should("eq", build_full_url(`${this.page_uri}?current_tab=stats`));
  });

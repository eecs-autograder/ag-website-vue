...
lint_paths=(
    ...
    'src/components/project_view/submission_detail/mutant_hints/unlocked_hint.vue'
    ...
    'tests/test_components/test_project_view/test_submission_detail/test_mutant_hints/test_unlocked_hint.ts'

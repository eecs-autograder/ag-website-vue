            ...
            <validated-form id="ag-test-suite-settings-form"
              ...
              <div class="bottom-of-form">
                ...
                <div v-show="!d_saving" class="last-saved-timestamp">
                  <span> Last Saved: </span> {{format_datetime(d_mutation_test_suite.last_modified)}}
                </div>
        ...
        <template slot="body">
          <div class="tab-body">
            <button class="delete-mutation-test-suite-button"
              ...
              Delete Test Suite: <span>{{d_mutation_test_suite.name}}</span>
            </button>
            ...
            <modal ref="delete_mutation_test_suite_modal"
              ...
              <div class="modal-body">
                <p> Are you sure you want to delete the suite
                  <span class="item-to-delete">{{d_mutation_test_suite.name}}</span>?
...
import {
    ExpectedStudentFile,
    get_sandbox_docker_images, InstructorFile,
...
export default class MutationSuiteSettings extends Vue {
  ...
  on_mutation_test_suite_change(new_test_suite: MutationTestSuite, old_test_suite: MutationTestSuite) {
    console.log("Switch mutation test suite in SETTINGS");
    this.d_mutation_test_suite = deep_copy(new_test_suite, MutationTestSuite);
    if (this.d_current_tab_index === 4) {
  ...
  save_mutation_test_suite_settings() {
    console.log("Trying to save");
  }

  delete_mutation_test_suite() {

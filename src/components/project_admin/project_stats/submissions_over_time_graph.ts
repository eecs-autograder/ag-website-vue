...
export default class SubmissionsOverTimeGraph extends Vue<Line> {
    ...
    compute_data_points() {
        // let start_rand = new Date("2020-10-12T02:19:16.927Z");
        // let end_rand = new Date("2020-10-14T19:19:16.927Z");
        // this.submissions = Array(1000).fill(null).map(item => {
        //     return {
        //         timestamp: new Date(start_rand.getTime() + Math.random() * (end_rand.getTime() - start_rand.getTime())),
        //     };
        // });

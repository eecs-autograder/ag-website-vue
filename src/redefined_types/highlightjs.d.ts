// NOTE: This is a local copy of node_modules/highlight.js/types/index.d.ts.
// The public version is incompatible with the AG typescript version, so it has
// been edited here to be usable. The original file should be usable after
// bumping to typscript version 4+.

/* eslint-disable no-unused-vars */
/* eslint-disable no-use-before-define */
// For TS consumers who use Node and don't have dom in their tsconfig lib,
// import the necessary types here.
/// <reference lib="dom" />
...
declare module 'highlight.js' {
    ...
    interface PublicApi {
        highlight: (codeOrLanguageName: string,
        ...
        regex: {
            ...
            // PROBLEMATIC LINE
            // either: (...args: (RegExp | string)[]
            //   | [...(RegExp | string)[], RegexEitherOptions]) => string,
            either: (...args: [(RegExp | string)[]?, RegexEitherOptions?]) => string, // fixed
    ...
    export interface HighlightResult {
        ...
        _emitter?: Emitter // Made optional to avoid needing it for the public API
    ...
    export type HLJSPlugin = {
        ...
        'after:highlightElement'?: (data: {
            el: Element, result: HighlightResult, text: string
        }) => void,
    ...
    export type HighlightedHTMLElement = HTMLElement & {
        result?: object, secondBest?: object, parentNode: HTMLElement
    }
    ...
    export type CompiledScope = Record<number, string> & {
        _emit?: Record<number, boolean>, _multi?: boolean, _wrap?: string
    };

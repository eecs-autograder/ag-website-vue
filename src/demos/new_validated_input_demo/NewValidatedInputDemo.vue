    ...
    <div id="validated-pair" style="padding: 10px;">
      ...
      <div id="validated-pair-1">
        ...
        <p>
          ...
          the component could listen for the validity_changed events of the child
          components and re-emit them without creating another validator.
